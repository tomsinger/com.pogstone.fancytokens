...
function fancytokens_civicrm_tokens( &$tokens ){  
	...
	if ($config->userSystem->is_drupal){
		if( function_exists("module_exists") && module_exists( "webform_civicrm") && module_exists( "webform_civicrm")){
	 	...
	 	$partial_token =  $token_as_array[0];
			...
			$result = civicrm_api('ContributionPage', 'getsingle', $params);
	               ...
	               foreach ( $contactIDs as $cid ) {
  		     	    ...
  		     	    $tmp_contrib_page_html = "<a href='".$full_contrib_page_link."' style='color:#fff!important;font-weight:bold!important;'>Click Here</a>";
